...
(function(demo) {
  ...
  var DemoIconsWorld = (function(_super) {
    ...
    function DemoIconsWorld() {
        ...
        this.CANVAS_W = 160;
        this.CANVAS_H = 40;
        this.WORD_LIST = ["DRR", "Natural", "GIS"];
    ...
    DemoIconsWorld.prototype.setup = function() {
      ...
      var mat = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('../../img/fire_particle.png')
      });
    ...
    DemoIconsWorld.prototype.createParticleCloud = function() {
      ...
      // マテリアルを作成
      var texture = THREE.ImageUtils.loadTexture('../../img/fire_particle.png');
    ...
    DemoIconsWorld.prototype.createLogo = function() {
      ...
      if (Math.random() < 0.3) {
        ...
        timeline.to(this.camera.position, 3.0, {
          x: 0,
          y: 0,
          z: 5000,
